...
export const VEHICLES_DATA: Vehicle[] = [
  {
    ...
    modules: {
      engine: [
        {
          name: "Saturn AL-51F-1 MK1",
          bonus: "+200 km/h speed",
        },
        {
          name: "Saturn AL-51F-1 MK2",
          bonus: "+400 km/h speed",
        },
        {
          name: "Saturn AL-51F-1 MK3",
          bonus: "+600 km/h speed",
        },
      ],
      stealth: [
