...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Comprehensive stats and comparison tool for all vehicles in Modern War Thunder.",
  ...
  twitter: {
    ...
    title: "MWT Assistant - Vehicle Stats & Comparison Tool",
    description:
      "Compare and analyze all vehicles in Modern War Thunder with detailed stats.",
